                    ...
                    <div class="calendar-options">
                        ...
                        <div class="calendar-btn-group" style="margin-bottom: 12px;">
                            ...
                            <div style="text-align: right; margin-top: 4px;">
                                <button onclick="showGoogleImportTypes()"
                                    style="background: none; border: none; font-size: 11px; color: var(--text-secondary); text-decoration: underline; cursor: pointer;">
...
// ...
                    ...
                    <div style="text-align: left; font-size: 13px;">
                        ...
                        <div style="margin-bottom: 10px; padding: 8px; background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 4px; color: #991b1b; font-size: 11px;">
                            <strong>Nota importante:</strong> Google Calendar solo puede importar URLs de servidores públicos. 
                            Si está probando en <strong>Localhost</strong>, esta opción fallará. Use "Descargar archivo .ICS" en su lugar.
                        </div>
